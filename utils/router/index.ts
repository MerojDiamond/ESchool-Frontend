...
export const sidebarRoutes = () => {
    return [
        ...
        makeMenuGroupItem("admin", "Administration", [
            makeMenuItem("admin.main", "Dashboard", "/admin/main"),
            makeMenuItem("admin.database", "Database", "/admin/database"),
            makeMenuItem("admin.others", "Others", "/admin/others"),
        ]),
    ]
}